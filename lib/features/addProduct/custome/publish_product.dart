          ...
          Expanded(
            ...
            child: Column(
             ...
             Card(
                ...
                Row( 
                  children: [
                     Expanded(child: Text("Regular Price",style: TextStyle(fontWeight: FontWeight.w700),)),
                     SizedBox(width: 20,),
                      Expanded(child: Text("Sale Price",style: TextStyle(fontWeight: FontWeight.w700))),
                       SizedBox(width: 20,),
                       Expanded(child: Text("Stock Count",style: TextStyle(fontWeight: FontWeight.w700)))
                  ],
                ),
                SizedBox(height:25)
                , Row(
                        ...
                        builder: (context, provider, child) {
                          return provider.isloading
                              ...
                              : DropdownButtonFormField(
                                  ...
                                  initialValue:
                                      provider.slectedbrand?.isEmpty ?? true
                                      ? null
